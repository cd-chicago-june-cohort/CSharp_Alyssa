...
namespace wall.Controllers
{
    public class WallController : Controller
    {
        ...
        public IActionResult PostMessage(MessageViewModel model)
        {
            ...
            DbConnector.Execute($"INSERT INTO messages (user_id, message, created_at) VALUES ({UserId}, '{model.message}', NOW())");
        ...
        {
            int? UserId = HttpContext.Session.GetInt32("UserId");
            DbConnector.Execute($"INSERT INTO comments (user_id, message_id, comment, created_at) VALUES ({UserId}, {message_id}, '{comment}', NOW())");
            return RedirectToAction("Wall");
        }
